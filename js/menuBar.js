...
$.openMenuBar = function() {
    ...
    if ((page[page.length-1] == 'index.html') || (page[page.length-1] == '') || (page[page.length-1] == 'levels.html'))
    	s += '<img id="current" src="sysPics/ClefCurrentPage.svg" style="width:17%;height:auto;padding-bottom:2px;">';
    ...
    if (page[page.length-1] == 'yak.html')
    	s+= '<img id="current" src="sysPics/ClefCurrentPage.svg" style="width:17%;height:auto;">';
