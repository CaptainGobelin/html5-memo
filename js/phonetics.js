...
['[s]#[in]#[k]#[an]#[t]','5%','','','','','','','','','','','','','','','','','',''],
['[s]#[ou]#[a]#[s]#[an]#[t]','6%','','','','','','','','','','','','','','','','','',''],
['[s]#[ou]#[a]#[s]#[an]#[t]#[d]#[i]#[s]','7%','','','','','','','','','','','','','','','','','',''],
['[k]#[a]#[t]#[r]#[v]#[in]','8%','','','','','','','','','','','','','','','','','',''],
['[k]#[a]#[t]#[r]#[v]#[in]#[d]#[i]#[s]','9%','','','','','','','','','','','','','','','','','',''],
['[s]#[an]','1%%','','','','','','','','','','','','','','','','','',''],
['[d]#[eu]#[s]#[an]','2%%','','','','','','','','','','','','','','','','','',''],
['[t]#[r]#[ou]#[a]#[s]#[an]','3%%','','','','','','','','','','','','','','','','','',''],
['[k]#[a]#[t]#[r]#[s]#[an]','4%%','','','','','','','','','','','','','','','','','',''],
...
$.strCompare = function(rule, word, pos, len) {
	...
	for (var i=0;i<ruleSize[0];i++) {
		...
		/*else if (rule[i] == '4') {
			...
			test = test && ($.isDigit(word, pos-ruleSize[0]+i)!=negative);
		}
		else if (rule[i] == '°') {
			test = test && ($.isDigitStrict(word, pos-ruleSize[0]+i)!=negative);
		}
		else if (rule[i] == '&') {
	...
	for (var i=0;i<ruleSize[2];i++) {
		...
		/*else if (rule[i+shift] == '4') {
			...
			test = test && ($.isDigit(word, pos+i+ruleSize[1]-tempShift)!=negative);
		}
		else if (rule[i+shift] == '°') {
			test = test && ($.isDigitStrict(word, pos+i+ruleSize[1]-tempShift)!=negative);
		}
		else if (rule[i+shift] == '&') {
