...
$.openOptionsBar = function() {
	...
	s += '<p class="leftMenu">';
	s += '<input type="button" class="colorButton colorRed" onClick=\'$.setCookie("color","#aa2d22",1);$.resizeWindow();\'/>';
	s += '<input type="button" class="colorButton colorOrange" onClick=\'$.setCookie("color","#f06025",1);$.resizeWindow();\'/>';
	s += '<input type="button" class="colorButton colorYellow" onClick=\'$.setCookie("color","#ffd318",1);$.resizeWindow();\'/>';
	s += '<input type="button" class="colorButton colorGreen" onClick=\'$.setCookie("color","#348b5d",1);$.resizeWindow();\'/>';
	s += '<input type="button" class="colorButton colorBlue" onClick=\'$.setCookie("color","#2167a7",1);$.resizeWindow();\'/>';
	s += '<input type="button" class="colorButton colorPurple" onClick=\'$.setCookie("color","#6a347f",1);$.resizeWindow();\'/>';
	s += '<input type="button" class="colorButton colorGrey" onClick=\'$.setCookie("color","#4e5565",1);$.resizeWindow();\'/>';
	s += '<input type="button" class="colorButton colorWhite" onClick=\'$.setCookie("color","white",1);$.resizeWindow();\'/>';
	s += '</p>';
	$optionsBar.append(s);
